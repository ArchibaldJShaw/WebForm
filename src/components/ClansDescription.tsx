        ...
        case 'Вентру': {
            ...
            <div id="descriptionVentrue">
                <h1>
                    ...
                    смертных.
                    Сородичи этого клана известны своим благородством, безупречным вкусом и своей благовоспитанностью.
                    Вентру - властители, следящие за соблюдением древних заветов, стремящиеся к управлению судьбами
                    вампиров.
                    Ныне клан пополняется потомственной денежной аристократией, безжалостными карьеристами и политиками.
                    Они стремяться сблизиться с верхами человеческого сообщества, гда их утонченность оказывается очень
                    полезной.
                    Вентру вращаются в одних кругах с Тореадорами, но они не тратят время на пустую болтовню и
